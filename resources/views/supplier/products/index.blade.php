    ...
    <div class="container-fluid d-flex flex-column gap-4 ">
        <div class="p-5 d-flex flex-column gap-4">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{ route('supplier.products.create') }}" class="h2 fw-bold btn btn-success px-3">
                    Add
                </a>
            </div>
                            ...
                            <div class="d-flex gap-3 p-4 w-100  ">
                                <div class="input-group" style="width: 100%;">
                                    ...
                                    <input name="name" type="text" class="form-control"
                                        placeholder="Search by product name ..." aria-label="Username"
                                ...
                                <div class="offcanvas-body d-flex flex-column gap-4">
                                    <div class="d-flex">
                                        <input type="checkbox" class="form-check-input me-1"
                                            onclick="document.getElementById('code').disabled = !this.checked;"
                                    ...
                                    <div class="d-flex">
                                        <input type="checkbox" class="form-check-input me-1 "
                                            onclick="document.getElementById('description').disabled = !this.checked;"
                                    ...
                                    <div class="d-flex">
                                        <input onclick="document.getElementById('is_variant').disabled = !this.checked;"
                                            type="checkbox" class="form-check-input me-1"
                                            {{ is_null(request('is_variant')) ?: 'checked' }}>
                                        <label class="w-25">
                                            Is Variant
                                        </label>
                                        <select name="is_variant" id="is_variant" class="dropdown-item form-select"
                                    ...
                                    <div class="d-flex">
                                        <input onclick="document.getElementById('hidden').disabled = !this.checked;"
                                            type="checkbox" class="form-check-input me-1"
                                            {{ is_null(request('hidden')) ?: 'checked' }}>
                                        <label class="w-25">
                                            Hidden
                                        </label>
                                        <select name="hidden" id="hidden" class="dropdown-item form-select"
                                    ...
                                    <div class="d-flex">
                                        <input onclick="document.getElementById('category_id').disabled = !this.checked;"
                                            type="checkbox" class="form-check-input me-1"
                                            {{ is_null(request('category_id')) ?: 'checked' }}>
                                        <label class="w-25">
                                            Category
                                        </label>
                                        <select name="category_id" id="category_id" class="dropdown-item form-select"
                            ...
                            <tbody class="table-group-divider" id="result">
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td class="">
                                            <img class="rounded-4 img-thumbnail" src="{{ asset($product->image) }}"
                                        ...
                                        <td class="">
                                            <form action=""></form>
                                            <form
                                                action="{{ route('supplier.products.update', ['product' => $product->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                        ...
                                        <td class="text-end">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('supplier.products.edit', ['product' => $product->id]) }}">Edit</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <form action=""></form>
                                                    <form
                                                        action="{{ route('supplier.products.destroy', ['product' => $product->id]) }}"
                                                        method="POST"
