...
@section('title',  request()->getHost() .' - Admin - Orders')
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasDarkNavbar"
                                ...
                                <div class="offcanvas-body d-flex flex-column gap-4">
                                    ...
                                    <div class="d-flex">
                                        <input type="checkbox" class="form-check-input me-1"
                                            onclick="document.getElementById('supplier_id').disabled = !this.checked;"
                                            @checked(request('supplier_id'))>
                                        <label class="w-25" for="supplier_id">
                                            Supplier
                                        </label>
                                        <select name="supplier_id" id="supplier_id"
                                            class="form-control select-control fs-6 fw-semibold"
                                            @disabled(!request('supplier_id'))>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"
                                                        href="{{ route('admin.orders.show', ['order' => $order->id]) }}">View</a>
                                                </li>
                                                <li>
