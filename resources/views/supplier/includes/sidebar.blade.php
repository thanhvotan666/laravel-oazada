<div class="bg-white border-end border-secondary py-5 p-2 text-center" style="width: min-content">
    <div class="d-flex flex-column gap-4 small stiky" style="width: fit-content; height:100%">
        <div class="text-secondary sidebar">
            <a href=" {{ route('supplier.dashboard') }} " class="{{ request()->is('supplier') ? 'active' : '' }} ">
        ...
        <div class="text-secondary sidebar">
            <a href="{{ route('supplier.products.index') }}"
                class="{{ request()->is('supplier/products*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
        ...
        <div class="text-secondary sidebar">
            <a href="{{ route('supplier.orders.index') }}"
                class="{{ request()->is('supplier/orders*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
        ...
        <div class="text-secondary sidebar">
            <a href="{{ route('supplier.profile.index') }}"
                class="{{ request()->is('supplier/profile*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
        ...
        <div class="text-secondary sidebar">
            <a href="{{ route('supplier.contacts.index') }}"
                class="{{ request()->is('supplier/contacts*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
