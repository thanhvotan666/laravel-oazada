...
@section('title', request()->getHost() . ': Admin - Dashboard')
@section('content')
    <main class="container-fluid p-0 bg-grey">
        <div class="container-fluid p-4 py-5 d-flex flex-column gap-3">
                        ...
                        <div class="bg-white rounded-4 border">
                            <div class="p-3 d-flex gap-4">
                                ...
                                <div>
                                    ...
                                    <!-- edit -->
                                    <div class="fs-5 fw-semibold">{{ $orderCount }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-3">
                        <div class="bg-white rounded-4 border">
                            <div class="p-3 d-flex gap-4">
                                ...
                                <div>
                                    <div class="fw-bold text-secondary small">SUPPLIER</div>
                                    <!-- edit -->
                                    <div class="fs-5 fw-semibold">{{ $supplierCount }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white rounded-4 border">
                            <div class="p-3 d-flex gap-4">
                                ...
                                <div>
                                    ...
                                    <!-- edit -->
                                    <div class="fs-5 fw-semibold">${{ $productCount }}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-4 border mt-4">
                <div class="px-4 py-3 fw-bold">
                    SUPPLIERS
                </div>
                <div>
        ...
        const productsChart = new Chart(productsCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: 'rgba(255, 0, 0, 0.2)', // Màu đỏ nhạt
                    borderColor: 'rgba(255, 0, 0, 1)', // Màu đỏ đậm
                    borderWidth: 2,
                    fill: true
                }]
            },
